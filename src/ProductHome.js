...
function ProductHome() {
    ...
    function productItems(products) {
        return (
            ...
            <Col>
                <Card key={product.id} style={{width: '18rem', padding: '15px', margin: '20px', textAlign: 'left', paddingBottom: '2px', backgroundColor: '#F5F1E3' }}>
  ...
  return (
        <>
            <Stack direction="vertical" gap={3} style={{backgroundColor: '#B2ABBF'}}>
            <h1 style={{padding: '15px', paddingBottom: '5px', marginTop: '5px'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Products</h1>
